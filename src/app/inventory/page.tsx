      ...
      <nav className="bg-[#0d0e13]/80 backdrop-blur-xl fixed top-0 w-full z-50 flex justify-between items-center px-8 h-20 shadow-[0_20px_40px_rgba(197,154,255,0.08)]">
        <div className="flex items-center gap-12">
          ...
          <div className="hidden md:flex gap-8 items-center">
            ...
            <Link className="text-[#c59aff] border-b-2 border-[#c59aff] pb-1 font-headline tracking-tight font-bold" href="#">Wallet</Link>
        ...
        <div className="px-6 mb-8">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-xl bg-surface-container-highest flex items-center justify-center">
              <span className="material-symbols-outlined text-[#c59aff]">auto_fix_high</span>
            </div>
            <div>
      ...
      <main className="md:ml-64 pt-24 px-8 pb-12">
        <header className="flex flex-col md:flex-row justify-between items-start md:items-end gap-6 mb-12">
          ...
          <div className="flex gap-4">
            <button className="flex items-center gap-2 px-6 py-3 rounded-full bg-surface-container-highest text-secondary font-bold hover:bg-surface-container transition-all">
              <span className="material-symbols-outlined">add</span> Deposit
            </button>
            <button className="flex items-center gap-2 px-6 py-3 rounded-full bg-surface-container-highest text-on-surface font-bold hover:bg-surface-container transition-all">
              <span className="material-symbols-outlined">vertical_align_bottom</span> Withdraw
            </button>
            <button className="flex items-center gap-2 px-6 py-3 rounded-full bg-gradient-to-r from-primary to-primary-dim text-on-primary-container font-bold shadow-lg shadow-primary/20 hover:scale-[1.02] active:scale-95 transition-all">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-12">
              ...
              <div className="flex justify-between items-start mb-8 relative z-10">
                <div className="flex items-center gap-3">
                  <div className="w-12 h-12 rounded-full bg-gradient-to-br from-[#FFD700] via-[#FDB931] to-[#917403] flex items-center justify-center shadow-lg">
                    <span className="material-symbols-outlined text-background font-bold">token</span>
                  </div>
                  <div>
                ...
                <span className="bg-secondary-container text-on-secondary-container px-3 py-1 rounded-full text-xs font-bold uppercase tracking-wider">Metal</span>
              </div>
              <div className="space-y-6 relative z-10">
                <div>
                  <p className="text-on-surface-variant text-sm mb-1 uppercase tracking-widest font-bold">Total Balance</p>
                  <p className="text-4xl font-extrabold font-headline text-on-surface">142.50 <span className="text-lg text-primary">sXAU</span></p>
                  <p className="text-secondary text-sm mt-1">≈ $285,420.00 USD</p>
                </div>
            ...
            <div className="bg-surface-container-low rounded-xl p-8 border border-white/5 relative overflow-hidden">
              ...
              <div className="space-y-6 relative z-10">
                <div>
                  ...
                  <p className="text-secondary text-sm mt-1">≈ $68,163.60 USD</p>
                </div>
                <div className="grid grid-cols-2 gap-4 pt-4 border-t border-white/5">
                  <div>
                    <p className="text-[10px] text-on-surface-variant uppercase tracking-widest mb-1">Available</p>
                ...
                <div className="w-full md:w-1/2">
                  <div className="flex items-center gap-3 mb-6">
                    ...
                    <div>
                      ...
                      <p className="text-on-surface-variant text-sm">Collateral and liquidity pool</p>
                    </div>
                  </div>
          ...
          <div className="space-y-8">
            <div className="bg-surface-container-low rounded-xl p-8 border border-white/5">
              ...
              <div className="mt-12 p-4 bg-surface-container-highest rounded-xl border border-white/5">
            ...
            <div className="bg-gradient-to-br from-surface-container-low to-[#1a1c24] rounded-xl p-8 border border-primary/10">
              ...
              <p className="text-sm text-on-surface-variant mb-6 leading-relaxed">Lock your synthetic assets in the high-yield vault to earn protocol rewards in AUREUM tokens.</p>
              <button className="w-full py-4 bg-surface-container-highest text-primary font-bold rounded-xl border border-primary/20 hover:bg-primary/5 transition-all">
                Open Vault Settings
              </button>
            </div>
          </div>
