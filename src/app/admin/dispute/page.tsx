    ...
    <div className="min-h-screen bg-background text-on-surface">
      ...
      <nav className="fixed top-0 w-full z-50 bg-[#0d0e13]/80 backdrop-blur-xl shadow-[0_20px_40px_rgba(197,154,255,0.08)] flex justify-between items-center px-8 h-20">
        <div className="flex items-center gap-12">
          ...
          <div className="hidden md:flex items-center gap-8 font-headline tracking-tight font-bold">
            ...
            <Link className="text-[#c59aff] border-b-2 border-[#c59aff] pb-1" href="/admin/dispute">Trades</Link>
      ...
      <aside className="hidden md:flex h-screen w-64 fixed left-0 top-0 pt-24 bg-[#121319] flex-col border-r border-[#f7f5fd]/5 z-40">
        <div className="px-6 mb-8">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-primary to-primary-dim flex items-center justify-center shadow-lg shadow-primary/20">
              <ShieldAlert className="text-on-primary-container w-5 h-5" />
            </div>
            <div>
        ...
        <nav className="flex-1 space-y-1">
          <a className="flex items-center gap-3 text-[#f7f5fd]/50 py-3 px-6 hover:bg-[#181920] transition-all font-body font-medium text-sm" href="/trade/merchant">
            <Store className="w-5 h-5" /> Merchant Dashboard
          </a>
          <a className="flex items-center gap-3 text-[#f7f5fd]/50 py-3 px-6 hover:bg-[#181920] transition-all font-body font-medium text-sm" href="/trade/buyer">
            <ShoppingCart className="w-5 h-5" /> Buyer Portal
          </a>
          <a className="flex items-center gap-3 text-[#f7f5fd]/50 py-3 px-6 hover:bg-[#181920] transition-all font-body font-medium text-sm" href="#">
            <Database className="w-5 h-5" /> Asset Inventory
          </a>
          <a className="flex items-center gap-3 bg-[#c59aff]/10 text-[#c59aff] rounded-r-full py-3 px-6 border-l-4 border-[#c59aff] font-body font-medium text-sm" href="#">
        ...
        <div className="p-6 mt-auto space-y-4">
          <button className="w-full bg-secondary text-on-secondary-fixed font-bold py-3 rounded-xl flex items-center justify-center gap-2 transition-all active:scale-95 shadow-lg shadow-secondary/10">
            <span className="text-lg">+</span> New Trade
          </button>
          <div className="pt-4 border-t border-outline-variant/30">
            <a className="flex items-center gap-3 text-[#f7f5fd]/50 py-2 hover:text-secondary transition-all text-sm" href="#">
              <HelpCircle className="w-4 h-4" /> Support
            </a>
            <a className="flex items-center gap-3 text-[#f7f5fd]/50 py-2 hover:text-error transition-all text-sm" href="#">
          ...
          <header className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
            <div className="lg:col-span-2 bg-surface-container-low p-8 rounded-xl flex flex-col justify-between relative overflow-hidden group">
              ...
              <div className="mt-8 flex flex-wrap gap-4 relative z-10">
                <div className="bg-surface-container p-4 rounded-xl flex items-center gap-4">
                  <Image width={40} height={40} alt="Buyer Avatar" className="rounded-full border-2 border-secondary/30 object-cover" src="https://lh3.googleusercontent.com/aida-public/AB6AXuDlYD63i81zyyhmcIkZ_7VHchcOn1FiLkNK_gHhpq41RNgm2Lby2LNSLS2ajS_rDTkXCmRMsznV_whTOZ0B7yI3BP8niDEjb_bUnUxQCKB3tjFGdjKMzXEZsyx5s4E1FzbnqS-SadQiEnX_j5wUYXpy3aClf7RQw5bGiwyoTAgq3RrT8irJ1lwXfkMsJYe1zrv9mvgm20NfHRQqoGPiUJRJCUtQvAMPbbiKpCrjh7LRPy20rfUCK6x65gttIMLbPgGkrMT1-tDTWPU" />
                  <div>
                ...
                <div className="bg-surface-container p-4 rounded-xl flex items-center gap-4">
                  <Image width={40} height={40} alt="Merchant Avatar" className="rounded-full border-2 border-primary/30 object-cover" src="https://lh3.googleusercontent.com/aida-public/AB6AXuBy_R3ks4mBHY8R7-5VjP9JOFdJHUA87EhZN5sfBeWePfbrndliybnFrvWgIxZ3pCKBqYNQbRPxHhhM4KG6Z5qdjNBWwNiiiN2Et6yuYuGObKywWdrg4YEfN3lttYV3ZApQ2n3ar8jCyvuWWAVjc-3GU201ENXrOBQ_-AfbRR_EGcai_6tFvW6854rx5Oe-FE6TDvcF2HirLvrMfOaD67ZyaKjSsdnzMVGuP4ab_2gjwVN8B9Lj30Mp8Dlm6uQyDtelrz6xcL7W8kE" />
                  <div>
            ...
            <div className="bg-surface-container-high p-8 rounded-xl flex flex-col items-center justify-center text-center border border-outline-variant/10 shadow-2xl">
              <div className="w-24 h-24 mb-6 relative">
                ...
                <Image width={96} height={96} alt="sXAU Asset" className="relative z-10 object-contain" src="https://lh3.googleusercontent.com/aida-public/AB6AXuAmaC6VBtgOBpwgL7gK9fYWdivB6C6k7y6UMh1C5g9hvbpOTmVEqTw9BdDbHAqC-Z0ftoDGNipL0GkSWYkCigpi6L_BUZkhWvD-zgOzhuXMt_9g1ypClecWeYjJWCWu_fiixat5_0FG9rNZ_2pthl4mUeGyqyuFSErToVoYsIZ2q6RkiRtLi8AiaImw2s3b1gXFsEp-jvBDj0amY2BIty-4pBsaqOdNNVvY-7GW35GVMTZHGuwVbFoIteS6015g2Sg-_g-cNDMgctI" />
              </div>
              ...
              <div className="bg-surface-container-low rounded-xl overflow-hidden flex flex-col h-[600px]">
                      ...
                      <div className="bg-surface-container p-4 rounded-r-2xl rounded-bl-2xl">
                        ...
                        <div className="bg-surface p-2 rounded-lg border border-outline-variant/20 cursor-pointer group">
                          <div className="relative">
                            <Image width={400} height={200} alt="Payment Confirmation" className="w-full rounded-md brightness-75 group-hover:brightness-100 transition-all object-cover" src="https://lh3.googleusercontent.com/aida-public/AB6AXuAP9UzboRH0WYo1paB_83qe60a4RvfDZU5SnEkD6Vti6ZpnE0FKGJS9l1v99CMlDSfq7pJOC_m9ysOX-jSH66sr1djV9h0-MShtOHsSkVwCQ_Elh1CXU-IKgMIYifDzdDOmHYqzD1ps7Wo32L2ZiRSDE_IiNAVbV-SpevU12vm6eDnIhtDC-2d8HZDNrkWOh99UQrg--F9aL4aUdKM4jfvTZe4f42OVdRycZH8Y0kbJu9rIh9CwUR9kB2b4JxaBHbUpUxNBTLMZ4UA" />
                ...
                <div className="p-4 bg-surface-container-high">
                  <div className="flex gap-3 bg-surface-container p-2 rounded-xl border border-outline-variant/10">
                    <input className="flex-1 bg-transparent border-none focus:ring-0 text-sm px-4 text-on-surface outline-none" placeholder="As an Admin, your messages are highlighted..." type="text" />
