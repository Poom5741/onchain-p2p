    ...
    <>
      <nav className="fixed top-0 w-full z-50 bg-transparent backdrop-blur-xl">
        <div className="flex justify-between items-center max-w-7xl mx-auto px-8 py-6">
          <div className="text-2xl font-black bg-gradient-to-r from-[#c59aff] to-[#9547f7] bg-clip-text text-transparent font-headline tracking-tight">
            Aureum
          </div>
          <div className="hidden md:flex items-center gap-10">
            <Link className="text-[#c59aff] border-b-2 border-[#c59aff] pb-1 font-headline font-bold tracking-tight transition-colors duration-300" href="/marketplace">Marketplace</Link>
            <Link className="text-[#f7f5fd] opacity-80 hover:text-[#c59aff] transition-colors duration-300 font-headline font-bold tracking-tight" href="#">Trades</Link>
            <Link className="text-[#f7f5fd] opacity-80 hover:text-[#c59aff] transition-colors duration-300 font-headline font-bold tracking-tight" href="#">Wallet</Link>
            <Link className="text-[#f7f5fd] opacity-80 hover:text-[#c59aff] transition-colors duration-300 font-headline font-bold tracking-tight" href="#">Help</Link>
          </div>
          <div className="flex items-center gap-4">
            <Link href="/merchant" className="hidden lg:block text-[#f7f5fd] font-bold py-2 px-4 hover:text-[#c59aff] transition-all">Merchant Portal</Link>
            <button className="bg-gradient-to-r from-[#c59aff] to-[#9547f7] text-[#330066] font-bold py-3 px-8 rounded-full scale-95 active:opacity-80 transition-all">Start Trading</button>
          </div>
        </div>
      </nav>
      ...
      <main>
        ...
        <section className="relative pt-40 pb-32 px-8 overflow-hidden">
          <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[120%] h-full opacity-20 pointer-events-none">
            <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,_var(--color-primary)_0%,_transparent_50%)] blur-3xl opacity-30"></div>
          </div>
          <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-16 relative z-10">
            <div className="flex-1 text-center lg:text-left">
              ...
              <div className="flex flex-col sm:flex-row gap-6 justify-center lg:justify-start">
                ...
                <Link href="/merchant" className="inline-flex items-center justify-center bg-surface-container-highest text-secondary font-bold text-lg px-10 py-5 rounded-full transition-all hover:bg-surface-container hover:scale-105 active:scale-95">
                  Become a Merchant
                </Link>
              </div>
            </div>
            <div className="flex-1 w-full max-w-xl">
              <div className="relative group">
                ...
                <div className="relative bg-surface-container-low rounded-xl p-2 border border-outline-variant/15 overflow-hidden h-[500px]">
                  <img alt="Synthetic Assets Hero" className="rounded-lg w-full h-full object-cover" src="https://lh3.googleusercontent.com/aida-public/AB6AXuAeRiVlOfT8EIaMYgpbpNMcWIZ7CZ2Qa4P3d7GXjS9YlmVUPygkQ7nsCVAIvTzZ1S-7v7ok3X1LT4rkGrfkz1uwLCYRWyMIShVZOpmiJIoW3rVv_QSDgl75TJ8q9QniHG9fUdAws5kAy-n225vYkkqB3dp4IPe_EUl5RQPDw7fskFRgmTShuVs8t3Rom1MtWOJHKQ4mK747pGPflryKlt0qxrUWWm_vI3jETwVgPjwg7zDySGz1G_odrp8PRs_kuU23NPleYMKlOtk" />
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              ...
              <div className="bg-surface-container p-8 rounded-xl border border-outline-variant/10 hover:border-secondary/30 transition-all group">
                <div className="w-14 h-14 bg-secondary-container rounded-full flex items-center justify-center mb-6 text-on-secondary-container">
                  <span className="material-symbols-outlined" style={{ fontVariationSettings: "'FILL' 1" }}>universal_currency_alt</span>
                </div>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="flex flex-col md:flex-row justify-between items-end mb-12 gap-6">
              ...
              <button className="text-primary font-bold flex items-center gap-2 hover:gap-4 transition-all">
                View All Markets <span className="material-symbols-outlined">trending_flat</span>
              </button>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="bg-surface-container-low rounded-lg p-8 flex items-center gap-8 relative overflow-hidden">
                ...
                <div className="h-24 w-24 rounded-full overflow-hidden bg-gradient-to-br from-yellow-500/20 to-orange-600/20 flex-shrink-0 flex items-center justify-center">
                  <img alt="sXAU" className="w-full h-full object-cover opacity-80" src="https://lh3.googleusercontent.com/aida-public/AB6AXuDGvDFUv28yk5LnL0gqICFbzDoRnybZQ8dg_JGgyrtdxu3rxmgro2w9irSiBoe_4i9MhOyAmqmW3aiVg17JFtNLphU3wvOhdKhLWwieZVSkzDRBaiuN8YSgCCH18J1yfRegdc17-b8CiSbC04D5U6oWJSoGz86RKTyKzhUCcQUVnMwD-gvXHPgfubRet1ojUM6KQjV-Kon-IFyW-L1Q_Lsq2Y0FuTXWMRv9ePitMKyElFOqK2plLuF228O4iYtFqebQAxP_yn2wv58" />
                </div>
              ...
              <div className="bg-surface-container-low rounded-lg p-8 flex items-center gap-8 relative overflow-hidden">
                <div className="absolute right-0 top-0 opacity-10">
                  <span className="material-symbols-outlined text-[10rem]">blur_on</span>
                </div>
                <div className="h-24 w-24 rounded-full overflow-hidden bg-gradient-to-br from-slate-400/20 to-slate-600/20 flex-shrink-0 flex items-center justify-center">
                  <img alt="sXAG" className="w-full h-full object-cover opacity-80" src="https://lh3.googleusercontent.com/aida-public/AB6AXuDAD_UTqddDap_QjgBMoxtpJwh1SgIEMqwl0vmEUFUuKVk76ET51tKBgkWhZHz5EvWw3kwbDYx5XIsc1Dw5860GnfGGHdbBfkJylanaMg8XtdQg4rKZZBlwP8t88wBxH49BO3q4okQG4lWPjid7YApDOTIPxejTyzreG8xZHgs7IQ58CR-jrZH7ru3d3_TSTmcOEOL37ZRwTywYWobuWtPHToRFJUKEpBhyrCEaHBxWazyE9coyKgU4ehwAPeK61mJUufsD08C2Kp8" />
                </div>
                <div className="flex-1">
                  <div className="flex justify-between items-start mb-2">
      ...
      <footer className="w-full rounded-t-[3rem] mt-20 bg-[#121319]">
        <div className="flex flex-col md:flex-row justify-between items-center px-12 py-16 gap-8 max-w-7xl mx-auto">
          <div className="flex flex-col gap-4 items-center md:items-start">
            <div className="text-lg font-bold text-[#f7f5fd] font-headline">Aureum P2P</div>
            <p className="text-[#f7f5fd] opacity-60 text-sm font-body tracking-wide">&copy; 2024 Aureum P2P. Secure Synthetic Alchemy.</p>
          </div>
          <div className="flex flex-wrap justify-center gap-8">
            <Link className="text-[#f7f5fd] opacity-60 text-sm tracking-wide font-body hover:text-[#9547f7] transition-all underline-offset-4 hover:underline" href="#">Terms of Service</Link>
            <Link className="text-[#f7f5fd] opacity-60 text-sm tracking-wide font-body hover:text-[#9547f7] transition-all underline-offset-4 hover:underline" href="#">Privacy Policy</Link>
            <Link className="text-[#f7f5fd] opacity-60 text-sm tracking-wide font-body hover:text-[#9547f7] transition-all underline-offset-4 hover:underline" href="#">Risk Disclosure</Link>
            <Link className="text-[#f7f5fd] opacity-60 text-sm tracking-wide font-body hover:text-[#9547f7] transition-all underline-offset-4 hover:underline" href="#">Community</Link>
            <Link className="text-[#f7f5fd] opacity-60 text-sm tracking-wide font-body hover:text-[#9547f7] transition-all underline-offset-4 hover:underline" href="#">Audit Reports</Link>
          </div>
        </div>
      </footer>
    </>
